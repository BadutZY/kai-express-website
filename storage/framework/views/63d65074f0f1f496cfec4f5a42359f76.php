    ...
    <div class="col-lg-4 fade-up">
        <div class="k-card" style="padding:28px;text-align:center;">
            <?php if($user->photo_profile): ?>
                <img src="<?php echo e(Storage::url($user->photo_profile)); ?>" alt="foto <?php echo e($user->name); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rizki\Pictures\INFOKOM-REACT\uji coba\kereta_api_updated\kereta_fixed\resources\views/admin/users/show.blade.php ENDPATH**/ ?>