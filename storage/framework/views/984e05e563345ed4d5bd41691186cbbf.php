...
<div class="row g-3">
    <div class="col-lg-4 fade-up">
        <div class="k-card" style="padding:28px;text-align:center;">
            <?php if($userPhoto): ?>
                <img src="<?php echo e(Storage::url($userPhoto)); ?>" alt="<?php echo e($penumpang->nama_penumpang); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rizki\Pictures\INFOKOM-REACT\uji coba\kereta_api_updated\kereta_fixed\resources\views/admin/penumpang/show.blade.php ENDPATH**/ ?>