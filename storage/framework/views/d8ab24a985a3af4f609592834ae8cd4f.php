...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'KAI Express'); ?> — Sistem Pemesanan Tiket</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-menu-toggle:hover { color: var(--text-primary); border-color: var(--border-hover); }
        ...
        .breadcrumb-wrap a:hover { color: var(--text-secondary); }
        .breadcrumb-wrap svg { width: 12px; height: 12px; }
        .breadcrumb-wrap .current { color: var(--text-primary); font-weight: 600; }
        ...
        .avatar-btn:hover { border-color: var(--border-hover); color: var(--text-primary); }
        ...
        .k-card:hover { box-shadow: var(--shadow-hover); border-color: var(--border-hover); }
        ...
        .k-card-title .icon-wrap svg { width: 14px; height: 14px; }
        ...
        .badge-kelas.ekonomi  { background: var(--green-soft);  color: #4ade80; border: 1px solid rgba(31,122,74,.3); }
        .badge-kelas.bisnis   { background: var(--gold-soft);   color: var(--gold); border: 1px solid rgba(200,149,42,.25); }
        .badge-kelas.eksekutif{ background: var(--purple-soft); color: #a78bfa; border: 1px solid rgba(91,63,166,.3); }
        ...
        .badge-count.high { background: var(--accent-soft); color: #f87171; border: 1px solid var(--accent-border); }
        .badge-count.low  { background: var(--green-soft);  color: #4ade80; border: 1px solid rgba(31,122,74,.3); }
        .badge-count.zero { background: var(--bg-surface3); color: var(--text-muted); border: 1px solid var(--border); }
        ...
        .btn-icon.view   { background: var(--blue-soft);   color: #60a5fa; }
        .btn-icon.edit   { background: var(--gold-soft);   color: var(--gold); }
        .btn-icon.delete { background: var(--accent-soft); color: #f87171; }
        ...
        .form-input option { background: var(--bg-surface2); }
        ...
        .invalid-msg svg { width: 13px; height: 13px; flex-shrink: 0; }
        ...
        .k-alert svg { width: 16px; height: 16px; flex-shrink: 0; margin-top: 1px; }
        .k-alert.success { background: var(--green-soft); border: 1px solid rgba(31,122,74,.3); color: #4ade80; }
        .k-alert.error   { background: var(--accent-soft); border: 1px solid var(--accent-border); color: #f87171; }

        /* ── ROUTE DISPLAY ── */
        .route-wrap { display: flex; align-items: center; gap: 7px; }
        .route-wrap .station { font-weight: 600; font-size: 13px; }
        .route-wrap svg { width: 13px; height: 13px; color: var(--accent); flex-shrink: 0; }
        ...
        .info-val { font-size: 13.5px; color: var(--text-primary); font-weight: 500; }
        ...
        .pagination .page-link:hover { background: var(--bg-surface3); border-color: var(--border-hover); color: var(--text-primary); }
...
<nav class="sidebar" id="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
            Dashboard
        </a>
...
<?php /**PATH C:\Users\rizki\Pictures\INFOKOM-REACT\uji coba\kereta_fixed\resources\views/layouts/admin.blade.php ENDPATH**/ ?>