            ...
            <div class="k-card-body" style="text-align:center;padding:28px 20px;">
                <div class="photo-wrap">
                    <?php if($user->photo_profile): ?>
                        <img id="profilePhotoPreview" src="<?php echo e(Storage::disk('public')->url($user->photo_profile)); ?>?v=<?php echo e($user->updated_at->timestamp); ?>" alt="foto profil">
                    <?php else: ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rizki\Pictures\INFOKOM-REACT\Laravel\kai_website_laravel\resources\views/user/profile.blade.php ENDPATH**/ ?>