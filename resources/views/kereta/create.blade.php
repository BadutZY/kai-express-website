...
<div class="page-header">
    <div style="display:flex;align-items:center;gap:12px;">
        ...
        <div>
            <h1 class="page-title">Tambah <span style="color:var(--kai-red)">Kereta</span></h1>
            <p class="page-subtitle">Daftarkan armada kereta baru</p>
        </div>
    </div>
</div>
        ...
        <div class="kai-card fade-up">
            <div class="k-card-header">
                <div class="k-card-title">
                    <span style="background:rgba(227,30,36,.12);color:var(--kai-red);width:32px;height:32px;border-radius:8px;display:flex;align-items:center;justify-content:center;"><i class="bi bi-train-front-fill"></i></span>
                    Form Data Kereta
                </div>
            </div>
            <div class="k-card-body">
                <form action="{{ route('kereta.store') }}" method="POST">
                    ...
                    <div style="display:flex;gap:12px;margin-top:28px;">
                        <button type="submit" class="btn-primary"><i class="bi bi-check-circle-fill"></i> Simpan</button>
