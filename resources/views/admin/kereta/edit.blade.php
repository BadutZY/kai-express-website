...
<div class="page-header"><div style="display:flex;align-items:center;gap:12px;">
    ...
    <div><h1 class="page-title">Edit <span>Kereta</span></h1><p class="page-subtitle">{{ $kereta->nama_kereta }}</p></div>
</div></div>
<div class="row justify-content-center"><div class="col-lg-6">
    <div class="k-card fade-up">
        ...
        <div class="k-card-body">
            <form action="{{ route('admin.kereta.update',$kereta->id_kereta) }}" method="POST">@csrf @method('PUT')
                <div class="form-group"><label class="form-label">Nama Kereta <span style="color:var(--accent)">*</span></label><input type="text" name="nama_kereta" value="{{ old('nama_kereta',$kereta->nama_kereta) }}" class="form-input" placeholder="cth: Argo Bromo Anggrek"></div>
